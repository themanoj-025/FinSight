"""Training helper functions for model training and evaluation.

Holds the shared machinery of the model benchmark (imports, logging, CV
constants, metadata helpers) plus the ``main()`` entry point that
``model_bench/train_and_compare.py`` re-exports for CLI use.
"""
